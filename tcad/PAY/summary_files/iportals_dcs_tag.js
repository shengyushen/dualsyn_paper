...
var gDomain="scout.ieee.org";
var gDcsId="dcs4b71nuo0lhbjb1tbttaym0_5x2m";
var gFpc="WT_FPC";
var gConvert=true;
...
// $DateTime: 2007/02/02 09:07:21 $
 ...
 function trackAndLaunch(mc_id,url)
 {
 	trackEvent(mc_id);
 	//alert("tracking mc_id:"+mc_id);
 	redirectTo(url);
 }
 
 function trackEvent(mc_id)
 {
 	
 	dcsMultiTrack('WT.mc_id',mc_id);
 	setTimeout('donothing()', 250);
 	//alert("dcsMultiTrack for mc_id done :"+ mc_id);
 }
 function donothing()
 {
