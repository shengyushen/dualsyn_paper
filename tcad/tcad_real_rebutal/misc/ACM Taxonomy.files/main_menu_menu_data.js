...
with(home4_mainbarStyle=new mm_style()){
borderwidth=0;
...
with(home4_submenuStyle=new mm_style()){
bordercolor="#888888";
borderstyle="solid";
borderwidth=1;
fontfamily="arial, tahoma";
...
aI("showmenu=elearning;align=center;text=e-Learning Campus;url=/portal/web/e-learning/home");
...
aI("image=http://www.computer.org/cms/Computer.org/Menus/Main%20Menu/joinbutton.png;itemwidth=125;url=/portal/web/membership/join;target=_blank;title=Join IEEE CS;onbgcolor=#7E8396;");

}

with(milonic=new menuname("Publications")){
margin=7;
style=home4_submenuStyle;
...
aI("text=TechSets;title=TechSets;url=/portal/web/buildyourcareer/techsets;");
}
...
aI("text=Career Center;url=/portal/web/careers;");
...
aI("text=Awards;url=/portal/web/awards;");
