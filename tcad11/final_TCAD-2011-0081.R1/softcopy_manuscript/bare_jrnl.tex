...
HuNan, 410073 CHINA. e-mail: \{syshen, yingqin, lqxiao, kfwang, jmzhang, skli\}@nudt.edu.cn, (see http://www.ssypub.org/).}% <-this % stops a space
...
which can be further unfolded to prove the non-existence of the decoder for all those longer paths.
...
and it is more than three times faster than previous ones.
\end{abstract}
...
\end{array}
\end{equation}
% Its correctness will be proved in the next subsection.
