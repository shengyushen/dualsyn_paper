...
\begin{figure}[tb]
  \centering
  \leavevmode
  \epsfig{file=mealy.eps, width=3.2in}
...
\textbf{XORMIN} is described below:
...
\hline
       &                 &XGXS&XFI& scra-   &PCIE&T2 et-	  \\
       &                 &       &      & mbler&    & hernet       	  \\ \hline
BFL    &run 	         &32.67  &time&8.56   &time&time	 	     \\
only   &time	         &&out&&out&out\\ \cline{2-7}
       &verilog   &2927   &N/A   &11882     &N/A &N/A 		     \\
       &line \#&       &      &          &    &        	  \\ \hline
XOR-   &run          &1.52   &2939&11.97     &47.55&36.64        	  \\
MIN   &time         &&&&& \\ \cline{2-7}
       &verilog&1525   &48829 &4723      &11254& 16616       	  \\
       &line \#&       &      &          &    &        	  \\ \hline
\end{tabular}
\end{table}
...
Temporal logic synthesis was first considered by \cite{DSGSYNTMPLG,SYNTMPLGSPC}.
...
%Its kernel is two-level logic minimization\cite{Espresso},
...
Classical logic synthesis \cite{Espresso} that work on AND-OR network can not deal with XOR efficiently,
...
This work was supported by Chinese NSF contract 60603088,
and the Program for Changjiang Scholars and Innovative Research Team in University No IRT0614.
