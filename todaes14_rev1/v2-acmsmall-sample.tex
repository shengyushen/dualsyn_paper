...
That is,
it requires that $\vec{i}$ must be uniquely determined on a state set $R^p$ that is reachable in $p$ steps from any states,
instead of on the reachable states $R$.
